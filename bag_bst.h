...
#pragma mark - Toolkit Function Implementation
    ...
    // to a copy of the removed item.
    {
        ...
        else
        {
            ...
            root_ptr = root_ptr->left(); // Promote left subtree
            delete oldroot_ptr;
            // END STUDENT WORK
        }
    }
    ...
    // function returns false).
    {
        ...
        {   // Target was found and there is no left subtree, so we can
            ...
            // STUDENT WORK
            // No left subtree: promote right child
            oldroot_ptr = root_ptr;
        ...
        // There is a left subtree... replace this node's data with
        // the maximum of the left subtree, then remove that max.

        Item removed;
        bst_remove_max(root_ptr->left(), removed);
        root_ptr->set_data(removed);
    ...
    // of the target were removed.
    {
        ...
        // Replace this node's data with max from left subtree,
        // then continue removing from (possibly) the same root.
        Item removed;
        bst_remove_max(root_ptr->left(), removed);
        root_ptr->set_data(removed);
...
#pragma mark - Member Function Implementation
    ...
    // Header file used: bintree.h
    {
        ...
        do
        {
            ...
            {   // Go left
                ...
                // Go left: duplicates allowed on the left
            ...
            {   // Go right
                ...
                // Go right: strictly greater entries
    ...
    typename bag<Item>::size_type bag<Item>::count(const Item& target) const
    {
        ...
        while (cursor != NULL)
        {
            ...
            else
            {
                ...
                // Any additional possible
                // matches must be in the left subtree,
                // because duplicates go to left.
                cursor = cursor->left();
    ...
    void bag<Item>::operator +=(const bag<Item>& addend)
    {
        if (root_ptr == addend.root_ptr)
        {
            ...
            // Self-add
            // make a copy first so we don't mutate while traversing
